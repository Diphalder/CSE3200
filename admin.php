...
<body>
    ...
    <div class="list">
        <div class="d-flex justify-content-center">
            ...
            <div onclick="myFunction()" class="btn-group">
                <form method='post'>
                    <button type="submit" class="btn btn-primary" name="polist">Program outcome</button>
                </form>
            </div>
    ...
    // ________ Program outcome  list________________
    ...
    <h3>Enter Departments</h3>
        <table class=" table table-striped">
                        ...
                        for ($i = 1; $i <= 12; $i++) {
                            $s = "SELECT poname from po where po=$i";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="<?php echo $i ?>" class="form-control" value="<?php echo $poname?>">
                            ...
                            <button type="submit" class="btn btn-success btn-block" name="savepo">Save</button>
                            </form>
                    </div>
                </div>
            </div>
    ...
    if (isset($_POST["savepo"])) {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $s = "select * from $datatable where po=$i";
                    $result = mysqli_query($con, $s);
                    $num = mysqli_num_rows($result);

                    if ($num == 0) {
                        $s = "INSERT INTO $datatable VALUES($i,'$po')";
                        mysqli_query($con, $s);
                    } else {
                
                        $query = "UPDATE $datatable  SET poname='$po' WHERE po=$i";
                        ...
                        <table class="table table-striped table-bordered ">
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <div class="checkbox">
                                        <td style="text-align: center;"><input type="checkbox" class='largerCheckbox' value="<?php echo $did ?>" name="deptids[]"></td>
                                    </div>
                                </tr>
                    ...
                    <form method='post'>
                        <div>
                            ...
                            <select class="form-control" name="deptid" required>
                                ...
                                while ($var = mysqli_fetch_assoc($result)) { ?><option value="<?php echo $var['deptid'] ?>"><?php echo $var['deptcode'] ?></option>
                                <?php
                                }
        ...
        ?>
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo  $dname ?></td>
                        <div class=" checkbox">
                            <td style="text-align: center;"><input type="checkbox" value="<?php echo $cid ?>" name="cids[]"></td>
                </div>
                </tr>
